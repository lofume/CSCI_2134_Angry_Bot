...
public class District { 
  ...
  private int SPRESSO_BOT_COUNT = 0;                  // current spresso count
  private TimBot resident;                       // ref to resident timbot
  private TimBot [] invaderBots = new TimBot[5]; // invading TimBots added here
  private int NUM_INVADERS_MOVE_PHASE = 0;                   // # of invaders at Move phase
  ...
  public void moveTimBot( TimBot bot ) {
    ...
    invaderBots[NUM_INVADERS_MOVE_PHASE] = bot;
    NUM_INVADERS_MOVE_PHASE++;
  }
  ...
  public void doHarvestPhase() {
    ...
    if( SPRESSO_BOT_COUNT == 0 ) {
      ...
      if( ( resident != null ) && resident.isFunctional() ) {
        ...
        SPRESSO_BOT_COUNT = spressoGrowth;
      }
    } else {
  ...
  public String toString() {
    if( ( resident != null ) && resident.isFunctional() ) {
      return String.format( "|%s %2d|", resident.toString(), SPRESSO_BOT_COUNT);
    } else {
      return String.format( "|          %2d|", SPRESSO_BOT_COUNT);
    }
  }
}
