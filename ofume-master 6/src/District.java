...
public class District { 
  ...
  public static final int CURRENT_DISTRICT = 0;
  ...
  /** 
     ...
     parameter: direction (NORTH, EAST, SOUTH, WEST, or CURRENT_DISTRICT

     return: the adjacent district in the specified direction
   */
  District getAdjoiningDistrict(int direction) {
  ...
  public void doSensePhase() {
    ...
    if( ( resident != null ) && resident.isFunctional() ) {
      ...
      resident.senseDistrict(CURRENT_DISTRICT, spresso, bots, this);
      resident.senseDistrict( NORTH, spresso, bots, this);
      resident.senseDistrict( EAST, spresso, bots, this);
      resident.senseDistrict( SOUTH, spresso, bots, this);
      resident.senseDistrict( WEST, spresso, bots, this);
