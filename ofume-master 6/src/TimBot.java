...
public class TimBot { 
  ...
  /** 
     ...
     elements represent the state of the District.CURRENT_DISTRICT district
  ...
  public int getNextMove() {
    // Never move
    return District.CURRENT_DISTRICT;
  }
   ...
   * @param district
   */
  void senseDistrict(int direction, int[] spresso,
                     boolean[] bots, District district) {
    // Get adjacent district, and query it for spresso count and timbot presence
    District d = district.getAdjoiningDistrict( direction );
