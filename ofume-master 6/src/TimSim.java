  ...
  */
  public static void main( String [] args ) {
    ...
    for( int i = 0; i < numBots; i++ ) {
      ...
      switch( personality ) {
      case "chicken":
        bots[i] = ChickenBot.createChickenBot( id, energy );
        break;
      case "spresso":
        bots[i] = SpressoBot.createSpressoBot( id, energy );
        break;
      case "angry":
        bots[i] = AngryBot.createAngryBot( id, energy );
        break;
      case "bully":
        bots[i] = BullyBot.createBullyBot( id, energy );
        break;
      }
